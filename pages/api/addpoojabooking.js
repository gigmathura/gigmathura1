...
export default async function handler(req, res) {
    if (req.method === 'POST') {
        try {
            ...
            const poojaBookingCollection = db.collection('poojabooking');
            // console.log(req.body)
            const { name, number, email,date,pid,pprice,pname} = req.body;
            ...
            const result = await poojaBookingCollection.insertOne(bookingData);
            ...
            const customerEmailOptions = {
                ...
                <html>
                    ...
                    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                        ...
                        <p>We’ve received your pooja booking request and will connect with you shortly on WhatsApp (<strong>${number}</strong>) for confirmation.</p>
...
//             };
            ...
            const adminEmailOptions = {
                ...
                subject: `New Pooja Booking , Booking Id:${bookingId}`,
                html: `
                    <h3>New Pooja Booking</h3>
    ...
    >
        Customer Contact
            ...
            res.status(201).json({ message: 'Pooja booking added and emails sent successfully!' });
        } catch (error) {
            console.error('Error adding Pooja booking:', error);
            res.status(500).json({ error: 'Failed to add Pooja booking', details: error.message });
        }
    } else {
