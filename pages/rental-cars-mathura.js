...
export default function Rentalcarsmathura({ cabData }) {
    ...
    return (
        <>
            <Head>
                <title>Rental Cars in Mathura - Easy and Affordable Travel</title>
                <meta
                    name="description"
                    content="Explore Mathura with convenient rental cars. Affordable rates, comfortable rides, and seamless booking for your travel needs."
                />
                <meta
                    name="keywords"
                    content="rental cars in Mathura, car rental Mathura, hire cars Mathura, Mathura travel services"
                />
                <meta
                    property="og:title"
                    content="Rental Cars in Mathura - Easy and Affordable Travel"
                />
                <meta
                    property="og:description"
                    content="Discover the best rental car services in Mathura. Enjoy hassle-free travel and explore the city's heritage at your own pace."
                />
                <meta
                    property="og:image"
                    content="/logo.png"
